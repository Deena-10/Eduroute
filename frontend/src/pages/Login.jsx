      ...
      <div style={{
        ...
        <div style={{ zIndex: 10 }}>
          ...
          <p style={{ marginTop: '16px', opacity: 0.9, maxWidth: '400px', fontSize: '18px', lineHeight: 1.6 }}>
            Log in to continue your personalized learning journey with EduRoute AI.
          </p>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 40px' }}>
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <h2 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '8px', color: '#1e293b' }}>Sign in to your account</h2>
